...
export const LeftBar: React.FC = () => {
  ...
  const navItems = [
    {
      path: "/funcionarios",
      icon: <FaUsers className="text-lg shrink-0" />,
      label: "Funcionários",
    },
    {
      path: "/departamentos",
      icon: <FaBuilding className="text-lg shrink-0" />,
      label: "Departamentos",
    },
    {
      path: "/perfil",
      icon: <FaUser className="text-lg shrink-0" />,
      label: "Perfil",
    },
  ];
    ...
    >
      ...
      >
        ...
        {!isCollapsed && (
          <div className="leading-tight">
            <h3 className="m-0 text-[#012b2c] font-bold text-base">
              PeopleCore
            </h3>
      ...
      <div className="mb-7">
        <button
          ...
          } ${isActive("/home") ? "ring-2 ring-white/20" : ""}`}
          ...
          >
            {user.avatarUrl ? (
              <img
                src={user.avatarUrl}
                alt={user.name}
                className="w-10 h-10 rounded-full object-cover border-2 border-[#00bac7] shrink-0"
              />
            ) : (
            ...
            {!isCollapsed && (
              <>
                <div className="flex flex-col flex-1 overflow-hidden">
                  ...
                  <span className="text-[#9cb1b2] text-[11px]">
                    {user.role}
                  </span>
                </div>
